...
export default function AboutUs() {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 mt-10">
      ...
      {/* Mission & Vision */}
      <section className="py-12 sm:py-16 px-4 md:px-20 grid md:grid-cols-2 gap-10 items-center">
        <div className="flex justify-center">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4x63DpZKV90rUBrJ6GUNFbKlEicvlpbuGpg&s"
            alt="Complaint Illustration"
            className="rounded-2xl w-64 sm:w-80 md:w-full shadow-lg hover:shadow-xl shadow-blue-400 transition"
          />
        </div>
        <div>
          <h2 className="text-2xl sm:text-3xl font-extrabold animate-pulse mb-6">
            📌 Our Mission
          </h2>
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold animate-pulse mb-4">
            📌 Our Vision
          </h2>
